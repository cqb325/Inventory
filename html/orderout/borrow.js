...
let Page = React.createClass({
    ...
    render() {
        ...
        let header2 = [{ name: "prod_name", text: "名称", tip: true }, { name: "amount", text: "剩余量" }, { name: "prod_num", text: "数量", format: countFormat }, { name: "op", text: "操作", format: btnFormat2 }];
        return React.createElement(
            'div',
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(FormControl, { label: React.createElement(
                            ...
                            ' 借用员工: '
                        ), ref: 'staff', type: 'autocomplete', data: [], name: 'staff_id', grid: 1, required: true }),
                    React.createElement(FormControl, { label: React.createElement(
                            'span',
                            null,
                    ...
                    React.createElement(FormControl, { label: React.createElement(
                            ...
                            ' 签署人: '
                        ), type: 'text', name: 'sign_user', grid: 1, required: true }),
                    React.createElement(FormControl, { label: React.createElement(
                            'span',
                            null,
