    ...
    render(){
        ...
        let btnFormat = function (value, column, row) {
            return (<span>
                ...
                <Button theme="success" className="ml-10" icon="trash" flat={true}
                        onClick={scope.showConfirm.bind(scope, row.prov_id)}>删除</Button>
            </span>);
        };
            ...
            <div className="main-container">
                ...
                <Label className="searchTools mt-30 mb-20" component="div">
                    ...
                    <Label className="text-right" grid={0.7}>
                        ...
                        <FormControl ref="prov_name" label="状态: " type="select" data={statusData} className="text-left"
