...
class DateRange extends BaseComponent {
     ...
     */
    render() {
        let className = classnames(this.props.className, 'cm-datetime', 'cm-dateRange', this.state.theme, {
        ...
        let startText = React.createElement(
            "span",
            { className: "date-text" },
        ...
        let endText = React.createElement(
            "span",
            { className: "date-text" },
