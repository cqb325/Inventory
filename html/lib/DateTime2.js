...
class Datetime extends BaseComponent {
    ...
    _getHeader(now) {
        ...
        let prev = this.state.stage == 3 ? null : React.createElement(
            "a",
            { className: "prev", onClick: this.prev.bind(this) },
            React.createElement("i", { className: "fa fa-chevron-left" })
        );
        let next = this.state.stage == 3 ? null : React.createElement(
            "a",
     ...
     */
    render() {
        let className = classnames(this.props.className, 'cm-datetime', this.state.theme, {
