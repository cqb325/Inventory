...
let List = React.createClass({
    ...
    render(){
        ...
        let btnFormat = function (value, column, row) {
            ...
            let sendBtn = <Button key="3" theme="success" className="ml-10" icon="cc-visa" flat={true} onClick={scope.sendConfirm.bind(scope, row.ord_no)}>出货时间</Button>;
            let detailBtn = <Button key="5" theme="success" className="ml-10" icon="bars" flat={true} href={"#export_payFund/"+row.ord_no+"/"+Format.ORDER_TYPE.INNER_BORROW}>查看</Button>;
        ...
        return (
            <div className="main-container">
                ...
                <Dialog title="已出货" ref="sendTip" grid={0.3} onConfirm={this.sendResult}>
                    <div className="mt-20">
                        <FormControl label="出货时间: " className="flex vertical-center" ref="send_time" name="sendTime" required>
                ...
                <Label className="searchTools mt-30 mb-20" component="div">
                    <Label className="" grid={0.3}>
                        <Button icon="plus" theme="success" className="ml-10" href="#export_borrow">内部产品借用</Button>
                    </Label>
