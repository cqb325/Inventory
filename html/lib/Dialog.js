    ...
    constructor(props) {
        ...
        this.footers = props.footers || {
            components: [React.createElement(
                Button,
                { theme: "success", raised: true, onClick: this.btnHandler.bind(this, true), icon: "save" },
                props.okButtonText || "保 存"
            ), React.createElement(
                Button,
                { theme: "info", raised: true, onClick: this.btnHandler.bind(this, false), icon: "flask", className: "ml-10" },
