...
const APP = {
    sysName: "CLY",
    menus: [{ id: "1", text: "供应商管理", icon: "fa fa-suitcase", link: "SupplierList", component: SupplierList }, { id: "2", text: "客户管理", icon: "fa fa-user", link: "SupplierList", component: SupplierList }, { id: "3", text: "产品入库", icon: "fa fa-inbox", link: "SupplierList", component: SupplierList }, { id: "4", text: "产品出库", icon: "fa fa-dropbox", link: "SupplierList", component: SupplierList }, { id: "5", text: "库存统计", icon: "fa fa-pie-chart", link: "SupplierList", component: SupplierList }]
};
